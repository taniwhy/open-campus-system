...
from .serializer import ParticipantSerializer, ParticipantIdSerializer, ParticipantHistorySerializer, SubjectSerializer
...
class ParticipantDetail(viewsets.ModelViewSet):
    ...
    """
    queryset = Participant.objects.all()
    serializer_class = ParticipantIdSerializer
    def get_queryset(self):
