...
class Participant(models.Model):
    ...
    school_name = models.CharField(verbose_name="高校名", max_length=50, null=True)
    school_year = models.IntegerField(verbose_name="学年", null=True)
    graduate_year = models.CharField(verbose_name="卒業予定年", max_length=50, null=True)
    graduated_check = models.BooleanField("高校卒業済み", null=True)
    graduate_qualification = models.BooleanField(verbose_name="高認取得済み", null=True)

class Participant_history(models.Model):
    """
    参加者履歴テーブル
    """
    class Meta:
