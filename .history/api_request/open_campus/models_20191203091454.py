...
class Participant(models.Model):
    ...
    school_name = models.CharField(verbose_name="高校名", max_length=50, null=True, brank=True)
    school_year = models.CharField(verbose_name="学年", max_length=10, null=True, brank=True)
    graduate_year = models.CharField(verbose_name="卒業予定年", max_length=50, null=True, brank=True)
    graduated_check = models.BooleanField(verbose_name="高校卒業済み", null=True, brank=True)
    graduate_qualification = models.BooleanField(verbose_name="高認取得済み", null=True, brank=True)
