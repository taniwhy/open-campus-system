...
class Participant(models.Model):
    ...
    graduated_check = models.BooleanField(verbose_name="高校卒業済み", blank=True, null=True)
    graduate_qualification = models.BooleanField(verbose_name="高認取得済み", blank=True, null=True)
