...
class Participant(models.Model):
    ...
    participant_id = models.UUIDField(verbose_name='ID', primary_key=True, default=uuid.uuid4, editable=False)
    ...
    phone_number = models.CharField(verbose_name='電話番号', max_lengt=11)
