        ...
        <v-card-text>
          ...
          <v-container style="width: 90%;" fluid>
            ...
            <v-form ref="test_form">
              ...
              <v-radio-group row v-model="data.form.gender">
                <v-radio id="男" v-model="data.form.gender" value="false" label="男" @change="data.form.gender=false"></v-radio>
                <v-radio id="女" v-model="data.form.gender" value="true" label="女" @change="data.form.gender=true"></v-radio>
              </v-radio-group>
