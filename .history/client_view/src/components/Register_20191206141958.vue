          ...
          <v-container style="width: 90%;" fluid>
            ...
            <v-form ref="test_form">
              ...
              <v-radio-group row v-model="data.picked">
                <v-radio  v-model="data.picked" id="男" value=false label="男" @change="data.form.gender=false"></v-radio>
                <v-radio v-model="data.picked" id="女" value=true label="女" @change="data.form.gender=true"></v-radio>
              </v-radio-group>
