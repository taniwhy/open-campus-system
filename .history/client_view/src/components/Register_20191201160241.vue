          ...
          <v-card ref="form" width="520px">
            <v-card-text>
              ...
              () => !!data.form.address && data.form.address.length <= 32 || '※32文字以内で入力してください',
                ...
                <v-radio-group row>
                  <v-radio label="学生" value="yes1" @change="data.student_check = true, form.job=false"></v-radio>
                  <v-radio label="その他" value="no1" @change="data.student_check = false, form.job=true"></v-radio>
                </v-radio-group>
              ...
              () => !!data.form.school_name && data.form.school_name.length <= 32 || '※32文字以内で入力してください',
                  ...
                  <v-select :items="data.graduate_year_list"  v-model="data.form.school_graduate_year" filled label="選択してください"></v-select>
                </div>
