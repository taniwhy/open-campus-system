      ...
      <div class="text-center">
        <v-overlay :value="overlay" color="grey darken-4">
          ...
          <div v-if="form_create">
            <h2>登録完了しました!</h2>
            <v-btn x-large flat to="/" class="ma-2" app color="cyan" dark width="120px" @click="this.reset">戻る</v-btn>
          </div>
          <div v-if="form_error">
            <h2>登録が成功しませんでした。</h2>
            <h2>もう一度最初からお願いします。</h2>
            <v-btn x-large flat to="/" class="ma-2" app color="cyan" dark width="120px" @click="reset">戻る</v-btn>
          </div>
        </v-overlay>
      </div>
      <br />
