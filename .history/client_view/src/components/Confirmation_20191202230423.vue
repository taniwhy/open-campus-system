...
import local_settings from "/src/local_settings"
  ...
  methods: {
    ...
    form_format: function() {
      ...
      this.form = {
        ...
        school_year: Number(this.data.form.school_year),
        graduate_year: this.data.form.graduate_year,
        graduated_check: this.data.form.graduated_check,
    ...
    form_post: function() {
      ...
      axios
        .post("http://127.0.0.1:8000/api/participant/", this.form, {
          auth: { username: "admin", password: "hunter628" }
        })
