        ...
        <v-card-text>
          ...
          <v-container style="width: 90%;" fluid>
            ...
            <v-form ref="test_form">
              ...
              <v-radio-group row v-model="data.picked" :rules="genderRules">
              ...
              <v-radio-group row v-model="data.picked_job" :rules="jobRules">
                <v-radio
                  label="学生"
                  value="false"
              ...
              <div v-if="!data.student_check">
                ...
                <v-radio-group row v-model="data.picked_guraduate_check" :rules="selectRules">
                ...
                <v-radio-group row v-model="data.picked_graduate_qualification" :rules="selectRules">
