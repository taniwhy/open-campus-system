            ...
            <v-card-text>
              ...
              <v-container style="width: 90%;" fluid>
                ...
                <v-form ref="test_form">
                  ...
                  {{data.gender_cehck}}
                  <v-radio-group row>
                    <v-radio v-model="gender_check" value="false" label="男" @change="data.form.gender=false"></v-radio>
                    <v-radio v-model="gender_check" value="true" label="女" @change="data.form.gender=true"></v-radio>
                  </v-radio-group>
