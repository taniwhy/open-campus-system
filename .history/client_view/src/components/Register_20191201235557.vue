          ...
          <v-card ref="form" width="520px">
            <v-card-text>
              ...
              () => !!data.form.first_name_reading && data.form.first_name_reading.length <= 15 || '※15文字以内で入力してください',
                ...
                <v-row style="height: 70px;">
                  <v-col style="height: 70px;">
                    <v-select v-model="data.form.birth_year" :items="data.years_list" label="年" dense solo></v-select>
                  </v-col>
                  <v-col style="height: 70px;">
                    <v-select v-model="data.form.birth_month" :items="data.months_list" label="月" dense solo></v-select>
                  </v-col>
                  <v-col style="height: 70px;">
                    <v-select v-model="data.form.birth_day" :items="data.days_list" label="日" dense solo></v-select>
                  </v-col>
                </v-row>
