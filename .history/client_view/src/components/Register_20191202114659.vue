            ...
            <v-card-text>
              ...
              <v-container style="width: 90%;" fluid>
                ...
                <v-form ref="test_form">
                  ...
                  {{data}}
                  <v-radio-group row>
                    <v-radio v-model="data.gender_check" id="1" label="男" @change="data.form.gender=false"></v-radio>
                    <v-radio v-model="data.gender_check" id="2"  label="女" @change="data.form.gender=true"></v-radio>
                  </v-radio-group>
