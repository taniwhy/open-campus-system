    ...
    <div class="text-center">
      <v-overlay :value="overlay" color="grey darken-4">
        ...
        <div v-if="form_create">
          <h2>ログイン完了</h2>
          <v-btn x-large flat class="ma-2" color="light-blue lighten-3" width="120px" @click="overlay=true">戻る</v-btn>
        </div>
        <div v-if="form_error">
          <h2>ログインできませんでした</h2>
          <h2>確認して下さい</h2>
          <v-btn x-large flat class="ma-2" color="light-blue lighten-3" width="120px">戻る</v-btn>
        </div>
      </v-overlay>
    </div>
  </v-app>
