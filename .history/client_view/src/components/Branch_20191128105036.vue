        ...
        <v-col>
          ...
          <v-row height="100px">
            <v-col>
              <v-row align="center" justify="end" style="width: 100%;">
                <div class="my-2">
                  <v-btn flat to="/register" x-large color="light-blue lighten-3" width=120px>はい</v-btn>
                </div>
              </v-row>
            </v-col>
            <v-col cols="1"></v-col>
            <v-col>
              <v-row align="center" justify="start" style="width: 100%;">
                <div class="my-2">
                  <v-btn flat to="/branch" x-large color="light-blue lighten-3" width=120px>いいえ</v-btn>
                </div>
              </v-row>
            </v-col>
          </v-row>
