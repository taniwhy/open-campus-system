    ...
    form_post: function() {
      axios
        .post("http://127.0.0.1:8000/api/subject/", {
          family_name: data.form.family_name,
          first_name: data.form.first_name,
          family_name_reading: data.form.family_name_reading,
          first_name_reading: data.form.first_name_reading,
          birthday: ,
          gender: false,
          phone_number: "",
          postal_code: "",
